                    ...
                    <div class="bg-secondary rounded-xl overflow-hidden shadow-lg evento-card">
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between gap-2">
                                ...
                                <a href="eventos/boletos.php?id=<?= $evento['id'] ?>" class="flex-1 btn-glow bg-gray-800 hover:bg-gray-700 text-white px-3 py-2 rounded-md text-sm text-center transition-all">
                                    <i class="fas fa-ticket-alt mr-1"></i> Boletos
                                </a>
                            </div>
                        </div>
                    </div>
